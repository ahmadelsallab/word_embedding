...
function [NM_strNetParams] = BP_startBackProp_SGD(CONFIG_strParams, NM_strNetParams, mTrainBatchData, mTrainBatchTargets,...
						...
						case 'SAME'
							switch(CONFIG_strParams.eMappingMode)
								case 'ADAPTIVE'
                                    ...
                                    % Start the minimizer                                                                        
                                    [dw, dw_class] = SGD_CLASSIFY(NM_strNetParams.cWeights, NM_strNetParams.mClassWeights, mCurrTrainMiniBatchData, mCurrTrainMiniBatchTargets, 0, 0, 0, 0,...
                                                           momentum, lrate, dw, dw_class);                                                       
