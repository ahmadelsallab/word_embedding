...
% corresponding index.
function [mReconstructedData, nErr] = TST_computeReconstruction(mBatchData, NM_strNetParams, nBitfieldLength, vChunkLength, vOffset, eFeaturesMode)
    ...
    nCodeSize = size(NM_strNetParams.cWeights{end}, 2);
...
%   err= err +  1/N*sum(sum( (data(:,1:end-1)-dataout).^2 )); 
        ...
        mReconstructedData = [mReconstructedData; mReconstructedBatchData];
